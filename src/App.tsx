...
export function App() {
  return (
  <main className="font-figtree flex flex-col items-center justify-center w-full h-full min-h-screen max-w-full bg-yellow ">
    
    <div className="w-full h-full max-w-[24rem] max-h-[32.625rem] p-6 rounded-[20px] bg-white shadow-3xl border border-black-b">
      <MainCard />

      <div className="flex flex-col items-start justify-start gap-y-3">
        <Label label="Learning" />
        <span className="font-medium text-base text-black-b">Published 21 Dec 2023</span>
        <h3 className=" text-2xl  font-extrabold text-black-c">HTML & CSS foundations</h3>
